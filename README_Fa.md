...
می‌توانید یک کانال اختصاصی تعریف کنید که در هر اجرا، مستقل از چرخه نوبتی،
فِچ می‌شود. ایده‌آل برای کانال‌هایی که نیاز به به‌روزرسانی مداوم دارند.
...
برای تنظیم کانال اولویت‌دار خود، متغیر PRIORITY_SLUG را در فایل .Fetch-feeds.sh به‌روزرسانی کنید.
```bash
PRIORITY_SLUG="STCdownload" # در هر اجرا فِچ میشود، جدا از سیستم چرخش نوبتی.
```
